...
public class DashboardController implements Initializable {
    ...
    private boolean addEmployeeIsEmpty() {
        ...
        try {
            ...
            if(addEmployeeIsEmpty()) {
                ...
                if(result.next()) {
                    ...
                    prepare.setString(8, String.valueOf(sqldDate));
                    ...
                    prepare.setString(6, String.valueOf(sqldDate));
                    prepare.executeUpdate();
        ...
        try {
            ...
            if(addEmployeeIsEmpty()) {
                ...
                if(option.get().equals(ButtonType.OK)) {
                    ...
                    String checkData = "SELECT * FROM employee_info WHERE employee_id = '" + addEmployee_employeeID.getText() + "'";
    ...
    public void addEmployeeInsertImage() {
        ...
        if(file != null) {
            ...
            image = new Image(file.toURI().toString(), 107,99,false,true);
        ...
        addEmployee_search.textProperty().addListener((Observable, oldValue, newValue) -> {
            ...
            filter.setPredicate(predicateEmployeeData -> {
                ...
                if (predicateEmployeeData.getEmployeeId().toString().contains(searchKey)) {
                    ...
                    return true;
                } else if (predicateEmployeeData.getGender().toString().toLowerCase().contains(searchKey)) {
                    return true;
                } else if (predicateEmployeeData.getPhoneNum().toLowerCase().contains(searchKey)) {
                    return true;
                } else if (predicateEmployeeData.getPosition().toString().toLowerCase().contains(searchKey)) {
                    return true;
    ...
    public ObservableList<EmployeeData> addEmployeeListData() {
        ...
        try {
            ...
            listData.sort(Comparator.comparingInt(EmployeeData::getEmployeeId));
        }
        catch(Exception ex) {
            ex.printStackTrace();
        }
    ...
    public void addEmployeeSelect() {
        ...
        image = new Image(uri, 107,99, false, true);
        addEmployee_image.setImage(image);
...
//        addEmployee_position.getSelectionModel().select(employeeD.getPosition());
    ...
    public void salaryUpdate() {
        String sql = "UPDATE employee_info SET salary = '" + salary_salary.getText() + "' WHERE employee_id = '" + salary_employeeID.getText() + "'";
        connect = Database.connectDb();
        try {
            Alert alert;
            if ( salary_employeeID.getText().isEmpty()
                ...
                alert.setTitle("Erorr Message");
                alert.setHeaderText(null);
                alert.setContentText("Please selecet item first");
                alert.showAndWait();
            }
            else {
                statement = connect.createStatement();
